...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <button disabled onClick="shutdown('127.0.0.1')">Выключить нахуй</button>
            <button disabled onClick="message('127.0.0.1')">Сообщение</button>
        </div>
        <div>
            <p>vitya</p>
            ...
            <button disabled onClick="message('192.168.1.39')">Сообщение</button>
        </div>
        <div>
            <p>Kostyan</p>
        ...
        <div>
            ...
            <button disabled onClick="message('192.168.1.58')">Сообщение</button>
        </div>
        <div>
            <p>vitalya</p>
            ...
            <button disabled onClick="message('192.168.1.69')">Сообщение</button>
        </div>
        <p id="info"></p>
